...
OPERATOR_DEPS_CACHE_ROOT="${OPERATOR_DEPS_CACHE_ROOT:-$WORKSPACE_ROOT/.deps}"
SPATIALMP4_ROOT="${SPATIALMP4_ROOT:-$OPERATOR_DEPS_CACHE_ROOT/src/SpatialMP4}"
FFMPEG_VERSION="${FFMPEG_VERSION:-8.1.1}"
DEFAULT_FFMPEG_SOURCE="$OPERATOR_DEPS_CACHE_ROOT/src/ffmpeg"
FFMPEG_TAG="${FFMPEG_TAG:-n${FFMPEG_VERSION}}"
FFMPEG_SOURCE="${FFMPEG_SOURCE:-$DEFAULT_FFMPEG_SOURCE}"
FFMPEG_BUILD_DIR="${FFMPEG_BUILD_DIR:-$OPERATOR_DEPS_CACHE_ROOT/build/ffmpeg}"
