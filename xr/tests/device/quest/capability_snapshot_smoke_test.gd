extends RefCounted
## WP7 device smoke test (Quest): dump the REAL PlatformRegistry capability
...
const CASE_ID := "device.quest.capability_snapshot"
...
func run(_ctx: Dictionary, t: OperatorTestAssertions) -> void:
	...
	var path := "user://test_results/capability_snapshot_quest.json"
