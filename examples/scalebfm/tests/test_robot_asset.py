...
def test_real_g1_export_matches_mujoco_body_and_visual_kinematics():
    path = os.environ.get("SCALEBFM_G1_XML")
    if not path:
        pytest.skip("set SCALEBFM_G1_XML to the real host ScaleBridge G1 model")
    ...
    data.qpos[7:] = np.sin(np.arange(29)) * 0.15
